...
![](../../assets/blog-images/截圖-2021-05-03-10.51.58-1024x253.png)

## 二、安裝 Pixel

輸入 pixel 名稱、選擇安裝類型。安裝類型有兩種，分別是：手動安裝和透過 GTM 安裝，我這邊就只有示範手動安裝的部分。

![](../../assets/blog-images/截圖-2021-05-03-10.52.08-1024x458.png)

## 三、手動安裝

選完手動安裝後，他會給你一段 base code，將這段 pixel code 安裝在網站 <head> </head> 之間 ，就完成了。

![](../../assets/blog-images/截圖-2021-05-03-10.52.46-1024x874.png)
